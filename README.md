...
[![PyPI version](https://badge.fury.io/py/loc-counter.svg)](https://pypi.org/project/loc-counter/)
...
# Basic usage
result = counter("your input here")
print(result)
```
